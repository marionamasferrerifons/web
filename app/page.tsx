...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <LogosSection
        logos={industryLogos
          .filter((item: { logo: { asset: { url: string } | null; alt?: string } | null; name: string }) => item.logo?.asset?.url)
          .map((item: { logo: { asset: { url: string }; alt?: string }; name: string }) => ({
      ...
      <ProblemSection />
      <CriterioSection />
      {orangeTestimonial?.avatar?.asset?.url && (
        <PracticeSection
          testimonial={{
      ...
      />
      {greenTestimonial?.avatar?.asset?.url && (
        <TestimonialSection
