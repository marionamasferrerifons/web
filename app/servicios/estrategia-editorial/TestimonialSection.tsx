...
export default function TestimonialSection({ cardColor = 'var(--color-orange-400)' }: { cardColor?: string }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from('.ts-tag',   { y: -20, opacity: 0, duration: 0.5 })
      ...
      <div className="mx-auto flex flex-col gap-[64px] items-center" style={{ maxWidth: '1400px' }}>
        ...
        >
          ...
          >
            ...
            <img
              src="/testimonial-logo-edebe.png"
              alt="Edebé"
              style={{
                position: 'absolute',
                top: '50%',
          ...
          <div className="flex-1 min-w-0 flex flex-col justify-center px-[20px] py-[32px] md:px-[64px] md:py-[56px]">
            ...
            >
              "Lorem ipsum dolor sit amet consectetur. Morbi nibh aliquam pretium tincidunt phasellus elementum porttitor. Vulputate at nascetur donec euismod non. Maecenas rhoncus euismod tortor eget."
            </p>
            ...
            <div className="ts-author flex items-center gap-[16px]" style={{ marginTop: '32px' }}>
              ...
              >
                Paul Irving, Principal Director de Edebé
              </p>
            </div>
          </div>
        </div>
